        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    <a class="brand" href="https://blog.csdn.net/Silence_silen"><i
                            class="icon-home iocn-white"></i> Silen--简易CSDN <span class="sml_t">Start</span></a>
                        ...
                        <#else>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#post" title="灌水" data-toggle="modal"
                                       ...
                                       onclick="javascript:addz();document.getElementById('submenu').innerHTML='发帖'">发帖子</a>
                                ...
                                <li><a href="user?action=logout"
                                       onclick="javascript:document.getElementById('submenu').innerHTML='退出当前用户'">退出当前用户</a></li>
                            </ul></li>
                    </ul>
